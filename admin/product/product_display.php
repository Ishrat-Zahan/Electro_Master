        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT products.id, products.cat_id, products.brand_id, products.title,products.pprice, products.sprice, products.images,products.discount,products.quantity, categories.name as cat_name, brands.name as brand_name  FROM products JOIN categories ON products.cat_id = categories.id JOIN brands ON products.brand_id=brands.id";
