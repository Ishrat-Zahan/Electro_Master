            ...
            <div class="sidebar-area">
                ...
                <div class="category-area">
                    ...
                    <ul class="category-list">
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">Smart phone</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">Desktop</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">laptop</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">Networking</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">software</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="show" href="">accessories</a></li>
                    </ul>
                </div>
                ...
                <div class="category-area">
                    ...
                    <ul class="category-list ">
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$5000-$10000</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$10000-$15000</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$15000-$20000</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$20000-$25000</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$25000-$30000</a></li>
                        <li><i class="fa-solid me-2 fa-caret-right"></i><a class="fs-6 show" href="">$30000+</a></li>
                    </ul>
                </div>
